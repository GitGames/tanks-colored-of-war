...
<head>
	<meta charset="utf-8">
	<title>Class: BaseTexture · Phaser CE</title>
...
<dt>
    <h4 class="name "
        id="skipRender"><span class="type-signature"></span>skipRender<span class="type-signature"> :Boolean</span></h4>
...
<p>You may want to do this if you have a parent Sprite with no visible texture (i.e. uses the internal <code>__default</code> texture)
that has children that you do want to render, without causing a batch flush in the process.</p>
    </div>
...
<dt>
    <h4 class="name "
        id="textureIndex"><span class="type-signature"></span>textureIndex<span class="type-signature"> :Number</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The multi texture batching index number.</p>
    </div>
...
<dt>
    <h4 class="name "
        id="forceLoaded"><span class="type-signature"></span>forceLoaded<span class="signature">(width, height)</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Forces this BaseTexture to be set as loaded, with the given width and height.
Then calls BaseTexture.dirty.
Important for when you don't want to modify the source object by forcing in <code>complete</code> or dimension properties it may not have.</p>
    </div>
...
<li>The new width to force the BaseTexture to be.</li>
</ul></td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><ul>
<li>The new height to force the BaseTexture to be.</li>
</ul></td>
        </tr>
