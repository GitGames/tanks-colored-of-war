...
<head>
	<meta charset="utf-8">
	<title>Class: Color · Phaser CE</title>
...
<dt>
    <h4 class="name "
        id=".hexToRGBArray"><span class="type-signature">&lt;static> </span>hexToRGBArray<span class="signature">(color)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<dt>
    <h4 class="name "
        id=".RGBArrayToHex"><span class="type-signature">&lt;static> </span>RGBArrayToHex<span class="signature">(rgb)</span><span class="type-signature"> &rarr; {number}</span></h4>
