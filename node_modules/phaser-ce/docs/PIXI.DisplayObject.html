...
<head>
	<meta charset="utf-8">
	<title>Class: DisplayObject · Phaser CE</title>
...
<dd>
    ...
    <div class="description">
        <p>The base class for all objects that are rendered. Contains properties for position, scaling,
rotation, masks and cache handling.</p>
<p>This is an abstract class and should not be used on its own, rather it should be extended.</p>
<p>It is used internally by the likes of PIXI.Sprite.</p>
    </div>
...
<dl class="details">
    ...
    <a href="src_pixi_display_DisplayObject.js.html">pixi/display/DisplayObject.js</a>, <a href="src_pixi_display_DisplayObject.js.html#sunlight-1-line-7">line 7</a>
    </dt>
