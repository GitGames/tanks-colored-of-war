...
<head>
	<meta charset="utf-8">
	<title>Class: EventTarget · Phaser CE</title>
...
<dl class="details">
    ...
    <a href="src_plugins_path_EventTarget.js.html">plugins/path/EventTarget.js</a>, <a href="src_plugins_path_EventTarget.js.html#sunlight-1-line-23">line 23</a>
    </dt>
    ...
    <pre class="sunlight-highlight-javascript">function MyEmitter() {}

     Phaser.EventTarget.mixin(MyEmitter.prototype);

     var em = new MyEmitter();
     em.emit('eventName', 'some data', 'some more data', {}, null, ...);</pre>
...
<dt>
    <h4 class="name "
        id=".call"><span class="type-signature">&lt;static> </span>call<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Backward compat from when this used to be a function</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_plugins_path_EventTarget.js.html">plugins/path/EventTarget.js</a>, <a href="src_plugins_path_EventTarget.js.html#sunlight-1-line-27">line 27</a>
    </dt>
