...
<head>
	<meta charset="utf-8">
	<title>Class: Bullet · Phaser CE</title>
...
<dd>
    ...
    <div class="description">
        <p>Create a new <code>Bullet</code> object. Bullets are used by the <code>Phaser.Weapon</code> class, and are normal Sprites,
with a few extra properties in the data object to handle Weapon specific features.</p>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Kills the Bullet, freeing it up for re-use by the Weapon bullet pool.
Also dispatches the <code>Weapon.onKill</code> signal.</p>
    </div>
