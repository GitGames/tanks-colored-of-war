...
<head>
	<meta charset="utf-8">
	<title>Class: PointerMode · Phaser CE</title>
...
<div class="container-fluid">
	...
	<!--<h1 class="page-title">Class: PointerMode</h1>-->
<section>
...
<dt>
    <h4 class="name "
        id="PointerMode"><span class="type-signature"></span>new PointerMode<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Enumeration categorizing operational modes of pointers.</p>
<p>PointerType values represent valid bitmasks.
For example, a value representing both Mouse and Touch devices
can be expressed as <code>PointerMode.CURSOR | PointerMode.CONTACT</code>.</p>
<p>Values may be added for future mode categorizations.</p>
    </div>
...
<dl class="details">
    ...
    <a href="src_input_Pointer.js.html">input/Pointer.js</a>, <a href="src_input_Pointer.js.html#sunlight-1-line-1252">line 1252</a>
    </dt>
...
<dt>
    <h4 class="name "
        id=".CONTACT"><span class="type-signature">&lt;static, constant> </span>CONTACT<span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A 'CONTACT' pointer has an <em>active cursor</em> that only tracks movement when actived; notably this is a touch-style input.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_input_Pointer.js.html">input/Pointer.js</a>, <a href="src_input_Pointer.js.html#sunlight-1-line-1267">line 1267</a>
    </dt>
...
<dt>
    <h4 class="name "
        id=".CURSOR"><span class="type-signature">&lt;static, constant> </span>CURSOR<span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A 'CURSOR' is a pointer with a <em>passive cursor</em> such as a mouse, touchpad, watcom stylus, or even TV-control arrow-pad.</p>
<p>It has the property that a cursor is passively moved without activating the input.
This currently corresponds with <a href="Phaser.Pointer.html#isMouse">Phaser.Pointer#isMouse</a> property.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_input_Pointer.js.html">input/Pointer.js</a>, <a href="src_input_Pointer.js.html#sunlight-1-line-1261">line 1261</a>
    </dt>
