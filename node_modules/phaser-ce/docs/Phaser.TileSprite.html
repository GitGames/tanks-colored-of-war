...
<head>
	<meta charset="utf-8">
	<title>Class: TileSprite · Phaser CE</title>
...
<dt>
    <h4 class="name "
        id="TileSprite"><span class="type-signature"></span>new TileSprite<span class="signature">(game, <span class="optional">x</span>, <span class="optional">y</span>, <span class="optional">width</span>, <span class="optional">height</span>, key, frame)</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A TileSprite is a Sprite that has a repeating texture. The texture can be scrolled and scaled independently of the TileSprite itself.
Textures will automatically wrap and are designed so that you can create game backdrops using seamless textures as a source.</p>
<p>TileSprites have no input handler or physics bodies by default, both need enabling in the same way as for normal Sprites.</p>
<p>You shouldn't ever create a TileSprite any larger than your actual screen size. If you want to create a large repeating background
that scrolls across the whole map of your game, then you create a TileSprite that fits the screen size and then use the <code>tilePosition</code>
property to scroll the texture as the player moves. If you create a TileSprite that is thousands of pixels in size then it will 
consume huge amounts of memory and cause performance issues. Remember: use <code>tilePosition</code> to scroll your texture and <code>tileScale</code> to
adjust the scale of the texture - don't resize the sprite itself or make it larger than it needs.</p>
<p>An important note about texture dimensions:</p>
<p>When running under Canvas a TileSprite can use any texture size without issue. When running under WebGL the texture should ideally be
...
bottom of your frame. To avoid this ensure your textures are perfect powers of two.</p>
<p>TileSprites support animations in the same way that Sprites do. You add and play animations using the AnimationManager. However
...
additional padding to enforce it to be so.</p>
    </div>
...
<dl class="details">
    ...
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-59">line 59</a>
    </dt>
        ...
        <ul>
            ...
            <li><a href="Phaser.Component.Health.html">Phaser.Component.Health</a></li>
        
            <li><a href="Phaser.Component.InCamera.html">Phaser.Component.InCamera</a></li>
...
<dt>
    <h4 class="name "
        id="canvasBuffer"><span class="type-signature"></span>canvasBuffer<span class="type-signature"> :<a href="PIXI.CanvasBuffer.html">PIXI.CanvasBuffer</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The CanvasBuffer object that the tiled texture is drawn to.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-118">line 118</a>
    </dt>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-82">line 82</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="refreshTexture"><span class="type-signature"></span>refreshTexture<span class="type-signature"> :boolean</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>If true the TileSprite will run <code>generateTexture</code> on its <strong>next</strong> render pass.
This is set by the likes of Phaser.LoadTexture.setFrame.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-140">line 140</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="textureDebug"><span class="type-signature"></span>textureDebug<span class="type-signature"> :boolean</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>If enabled a green rectangle will be drawn behind the generated tiling texture,
allowing you to visually debug the texture being used.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-111">line 111</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="tilePattern"><span class="type-signature"></span>tilePattern<span class="type-signature"> :object</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The Context fill pattern that is used to draw the TilingSprite in Canvas mode only (will be null in WebGL).</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-132">line 132</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="tilePosition"><span class="type-signature"></span>tilePosition<span class="type-signature"> :<a href="Phaser.Point.html">Phaser.Point</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The offset position of the image being tiled.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-103">line 103</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="tileScale"><span class="type-signature"></span>tileScale<span class="type-signature"> :<a href="Phaser.Point.html">Phaser.Point</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The scale applied to the image being tiled.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-93">line 93</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="tileScaleOffset"><span class="type-signature"></span>tileScaleOffset<span class="type-signature"> :<a href="Phaser.Point.html">Phaser.Point</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The scale offset applied to the image being tiled.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-98">line 98</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="tilingTexture"><span class="type-signature"></span>tilingTexture<span class="type-signature"> :<a href="PIXI.Texture.html">PIXI.Texture</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>An internal Texture object that holds the tiling texture that was generated from TilingSprite.texture.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-125">line 125</a>
    </dt>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-76">line 76</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="autoScroll"><span class="type-signature"></span>autoScroll<span class="signature">(x, y)</span><span class="type-signature"> &rarr; {<a href="Phaser.TileSprite.html">Phaser.TileSprite</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-208">line 208</a>
    </dt>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-243">line 243</a>
    </dt>
...
<dd>
    ...
    <div class="description">
        <p>Internal method that generates a new tiling texture.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-518">line 518</a>
    </dt>
...
<dd>
    ...
    <div class="description">
        <p>Returns the framing rectangle of the Tile Sprite.</p>
    </div>
...
<span class="param-type"><a href="Phaser.Rectangle.html">Phaser.Rectangle</a></span>
 ...
 -
    ...
    <div class="returns-desc param-desc">
        <p>The bounds of the Tile Sprite.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-605">line 605</a>
    </dt>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-180">line 180</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="reset"><span class="type-signature"></span>reset<span class="signature">(x, y)</span><span class="type-signature"> &rarr; {<a href="Phaser.TileSprite.html">Phaser.TileSprite</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-275">line 275</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="setTexture"><span class="type-signature"></span>setTexture<span class="signature">(texture)</span><span class="type-signature"> &rarr; {<a href="Phaser.TileSprite.html">Phaser.TileSprite</a>}</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Changes the texture being rendered by this TileSprite.
Causes a texture refresh to take place on the next render.</p>
    </div>
...
<span class="param-type"><a href="PIXI.Texture.html">PIXI.Texture</a></span>
            ...
            <td class="description last"><p>The texture to apply to this TileSprite.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-297">line 297</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="stopScroll"><span class="type-signature"></span>stopScroll<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Phaser.TileSprite.html">Phaser.TileSprite</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_gameobjects_TileSprite.js.html">gameobjects/TileSprite.js</a>, <a href="src_gameobjects_TileSprite.js.html#sunlight-1-line-228">line 228</a>
    </dt>
