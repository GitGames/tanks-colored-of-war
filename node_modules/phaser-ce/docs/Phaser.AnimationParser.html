...
<head>
	<meta charset="utf-8">
	<title>Class: AnimationParser · Phaser CE</title>
...
<dt>
    <h4 class="name "
        id=".JSONData"><span class="type-signature">&lt;static> </span>JSONData<span class="signature">(game, json)</span><span class="type-signature"> &rarr; {<a href="Phaser.FrameData.html">Phaser.FrameData</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_animation_AnimationParser.js.html">animation/AnimationParser.js</a>, <a href="src_animation_AnimationParser.js.html#sunlight-1-line-114">line 114</a>
    </dt>
...
<dt>
    <h4 class="name "
        id=".JSONDataHash"><span class="type-signature">&lt;static> </span>JSONDataHash<span class="signature">(game, json)</span><span class="type-signature"> &rarr; {<a href="Phaser.FrameData.html">Phaser.FrameData</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_animation_AnimationParser.js.html">animation/AnimationParser.js</a>, <a href="src_animation_AnimationParser.js.html#sunlight-1-line-230">line 230</a>
    </dt>
...
<dt>
    <h4 class="name "
        id=".JSONDataPyxel"><span class="type-signature">&lt;static> </span>JSONDataPyxel<span class="signature">(game, json)</span><span class="type-signature"> &rarr; {<a href="Phaser.FrameData.html">Phaser.FrameData</a>}</span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>The JSON data from the Texture Atlas. Must be in Pyxel JSON format.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_animation_AnimationParser.js.html">animation/AnimationParser.js</a>, <a href="src_animation_AnimationParser.js.html#sunlight-1-line-173">line 173</a>
    </dt>
...
<dt>
    <h4 class="name "
        id=".spriteSheet"><span class="type-signature">&lt;static> </span>spriteSheet<span class="signature">(game, key, frameWidth, frameHeight, <span class="optional">frameMax</span>, <span class="optional">margin</span>, <span class="optional">spacing</span>, <span class="optional">skipFrames</span>)</span><span class="type-signature"> &rarr; {<a href="Phaser.FrameData.html">Phaser.FrameData</a>}</span></h4>
...
<span class="param-type">Image</span>
            ...
            <td class="description last"><p>The Game.Cache asset key of the Sprite Sheet image or an actual HTML Image element.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The total number of animation frames to extract from the Sprite Sheet. The default value of -1 means &quot;extract all frames&quot;.</p></td>
        </tr>
...
<dt>
    <h4 class="name "
        id=".XMLData"><span class="type-signature">&lt;static> </span>XMLData<span class="signature">(game, xml)</span><span class="type-signature"> &rarr; {<a href="Phaser.FrameData.html">Phaser.FrameData</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_animation_AnimationParser.js.html">animation/AnimationParser.js</a>, <a href="src_animation_AnimationParser.js.html#sunlight-1-line-292">line 292</a>
    </dt>
