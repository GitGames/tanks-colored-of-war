...
<head>
	<meta charset="utf-8">
	<title>Class: Ninja · Phaser CE</title>
...
<dt>
    <h4 class="name "
        id="convertTilemap"><span class="type-signature"></span>convertTilemap<span class="signature">(map, layer, slopeMap)</span><span class="type-signature"> &rarr; {array}</span></h4>
