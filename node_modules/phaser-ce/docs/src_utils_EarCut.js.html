...
<head>
	<meta charset="utf-8">
	<title>Source: src/utils/EarCut.js · Phaser CE</title>
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<h1 class="page-title">Source: src/utils/EarCut.js</h1>
    
    <section>
        <article>
            <pre class="sunlight-highlight-javascript linenums">/* jshint ignore:start */
